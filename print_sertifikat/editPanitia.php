...
?>
    <div class="container">
    <div class="row">
        <form action="updatePanitia.php" method="POST" role="form">
            <legend>Edit Panitia</legend>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" placeholder="Nama Panitia" required value="<?=$row['nama']?>">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary">Update Panitia</button>
        </form>
    </div>
    </div>
